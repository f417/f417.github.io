...
**F417共享版0.5.0(2021.10.20)(支持Excel2021)**

支持用友NCC202105。

<p><font color="red">F417共享版 for NCC的注册费调整为<b>498</b>元。</font></p>

> F417共享版 for NCC不再要求单独在客户端上安装用友NC客户端了，安装时选择“网络NC客户端”模式，只需安装32位JAVA运行环境(JRE1.8以上)即可。
>
...
F417 for NCC，可以使用“网络NC客户端”方式，只需IE浏览器可以登录NC系统即可，无需单独安装NC本地客户端。(NCC202105测试通过)
...
![](/images/f417_nc/f417_ncc202105_share_query_book_1.png)
...
- 下载1
  ...
  目录：F417 for yonyou NC Cloud

  文件：F417sha050_ncc.7z
